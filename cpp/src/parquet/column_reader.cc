...
std::array<qpl_job *, QplJobHWPool::MAX_HW_JOB_NUMBER> parquet::QplJobHWPool::hw_job_ptr_pool;
std::array<std::atomic_bool, QplJobHWPool::MAX_HW_JOB_NUMBER> parquet::QplJobHWPool::hw_job_ptr_locks;
...
class FLBARecordReader : public TypedRecordReader<FLBAType>,
 ...
 public:
  ...
  void ReadValuesDense(int64_t values_to_read, int64_t &num_decoded) override {
